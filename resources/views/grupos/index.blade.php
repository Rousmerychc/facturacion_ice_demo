...
<div class="divpagina">
    <div class = "titulobotonagregar">
        <div>    
        <h3 class='titulos'><i class="fas fa-angle-double-right"></i> GRUPOS ICE Y PORCENTUAL</h3>
        </div>
            <div>
            @if (session('status'))
        ...
        <table class ="table table-sm table-striped table-bordered" id="grupo">
            <thead class="table-success">
                <tr class="tr1">
                    <td>Codigo</td>
                    <td>Descripcion</td>
                    <td>Ice Porcentual</td>
                    <td>Ice Especifico</td>                    
                    <td>Actions</td>                   
                </tr>
            </thead>
            <tbody>
...
$(function () {
 ...
 var table = $('#grupo').DataTable({
     ...
     columns: [
         ...
         {data: 'ice_porcentual', name: 'ice_porcentual'}, 
         {data: 'ice_especifico', name: 'ice_especifico'},       
         {
             data: 'btn', 
             name: 'btn', 
             orderable: true, 
