...
<div class="divpagina">
    <div class = "titulobotonagregar">
        <div>    
        <h3 class='titulos'><i class="fas fa-angle-double-right"></i> FACTURAS TASA CERO</h3>
        </div>
          ...
          <input type="text" id = "linea" value = "1">
          <button type="button" class="btn btn-success" id ="botonlinea" onclick="linea1();"> <label for="" id ="linealabel">EN LINEA</label></button>
          <div class="btn-group divbotonagregar " role="group" aria-label="Basic example">
            
            <a href="{{ action('FacturaTasaCeroController@emisionFueraLinea') }}" id = "link_fuera_linea1"></a>
            <button type="button" class="btn btn-primary botonespadig"><a href="{{ action('FacturaTasaCeroController@create') }}"> NUEVA FACTURA</a> </button>
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form  method="POST" action="{{ url('anular_facT') }}" autocomplete="off">
          @csrf
...
<script>
  function linea1(){
    ...
    if(linea == 1){
        ...
        document.getElementById("link_fuera_linea1").click();
