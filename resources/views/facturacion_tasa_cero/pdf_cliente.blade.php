...
<body>
    <div>
        <table>
            ...
            <tr>
                <td colspan = "3" class = "titfac"> <div ><center>FACTURA TASA CERO - VENTA DE LIBROS O TRANSPORTE DE CARGA</center> </div></td>
            </tr>
            <tr>
                <td colspan = "3" class = "titfac2"> <div ><center>INTERNACIONAL</center> </div></td>
            </tr>
            <tr>
                <td colspan = "3"><center>(Sin Derecho a Crédito Fiscal)</center></td>
            </tr>
        </table>
    </div>
