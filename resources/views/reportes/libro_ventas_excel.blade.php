...
<tr>
    <th colspan = "5" style ="text-align: center; font-size: 18; font-weight: bold;">Orbol S.A.</th>
</tr>  

<tr>
    <th colspan = "5" style ="text-align: center; font-size: 14; font-weight: bold;"> Movimiento Diario </th>
</tr>
<tr>
    <th colspan = "5" style ="text-align: center; font-size: 10; font-weight: bold;"> Fecha inicial: {{$fechaini}} Fecha Final: {{$fechafin}}</th>
</tr>
         
<tr>
    <th style="width:280px; text-align: center; background-color: #98DCC2; border: 1 solid #000000; font-weight: bold;">Cliente</th>
...
<tbody>
    ...
    @foreach($factura as $fac)
        ...
        @endforeach
        <tr>
            <td colspan ="3" style ="border: 1 solid #000000;"></td>
